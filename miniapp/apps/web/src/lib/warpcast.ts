...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "SCALEDOTFUN, the first decentralized launchpad for annotated datasets.", // 30 characters, no emojis or special characters, short description under app name
      description: "SCALEDOTFUN, the first decentralized launchpad for annotated datasets.", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      ...
      ogDescription: "SCALEDOTFUN, the first decentralized launchpad for annotated datasets.", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
